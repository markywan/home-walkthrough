...
- 人物：Three.js 官方示例 [Michelle.glb](https://threejs.org/examples/models/gltf/Michelle.glb)，来源 Mixamo。用于成品互动场景中的身高参照，未提供素材包下载功能。[Adobe Mixamo FAQ](https://helpx.adobe.com/creative-cloud/faq/mixamo-faq.html) 说明角色及动画可用于个人、商业和非营利项目。未使用舞蹈动画；依据骨骼生成站立和缓慢行走姿态，按包围盒校准至 1.65m。
