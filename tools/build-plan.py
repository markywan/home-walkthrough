...
add('<text x="60" y="48" font-size="30" font-weight="650" fill="#234c43">方案 A · 当前布局</text><text x="60" y="80" font-size="15" fill="#718173">次卧床柜换向 · 主卧双床头柜 / 门向对调 · 淋浴区新增蹲便</text><text x="1010" y="103" text-anchor="end" font-size="18" fill="#234c43">北 ↑</text>')
...
bed(.6,4.61);rect(3.3,4.38,.6,2.33);txt(3.6,5.52,'连续衣柜 2330×600',14,rotate=90)
...
rect(6.33,1.37,2.22,.6,'#e1d6be');rect(7.95,1.97,.6,.96,'#e1d6be');rect(6.46,1.44,.62,.43,'#344540','#344540',1,4)
ellipse(6.63,1.655,.094,.094,'#344540','#d5dfd8');ellipse(6.93,1.655,.094,.094,'#344540','#d5dfd8');rect(8.045,2.205,.415,.55,'#c4d1cb','#8da399',1,5)
rect(7.35,1.37,1.2,.32,'none','#698c72',1,0,'4 3');txt(7.1,2.56,'厨房',19,weight='600')
...
add('<text x="65" y="912" font-size="16" fill="#234c43">次卧：床头靠北 / 东侧衣柜 / 床柜间850　　主卧：左下高柜改床头柜 / 门向对调</text>')
add('<text x="65" y="944" font-size="14" fill="#8a7153">蹲便器按600×450示意；排污管、沉箱和防水条件待核。虚线柜体为上方吊柜。</text>')
