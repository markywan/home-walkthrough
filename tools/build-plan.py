...
rect(6.45,.06,.6,.42);ellipse(6.75,.28,.22,.14);ellipse(7.36,.40,.18,.24);rect(7.1725,.04,.375,.15,'#fafbf7');txt(7.30,.93,'紧凑马桶600',10)
rect(7.68,.01,.86,1.19,'#e2ebe4','#bdcac2');line(7.65,0,7.65,.50,'#83bcc6',3)
rect(7.84,.05,.52,.42,'#fffef5','#96aaa1',1,4);ellipse(8.1,.26,.185,.10,'#b6c9c0')
for z in [.10,.40]:
 for k in range(7):line(7.92+k*.053,z,7.92+k*.053,z+.035,'#b3c1b6',1)
rect(7.67,.48,.87,.72,'none','#8da79a',1,0,'3 2');txt(8.10,.76,'淋浴站位',10);txt(8.10,.93,'约880×740',10);txt(7.42,-.44,'卫生间（进深待核）',16,weight='600')
...
rect(6.195,3.08,2.34,.35);line(6.795,3.08,6.795,3.43,'#b49a74',1);txt(6.495,3.255,'茶台',12);txt(7.68,3.255,'电视书柜 D350',12)
